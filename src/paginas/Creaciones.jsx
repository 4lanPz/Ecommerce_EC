...
const Creaciones = () => {
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold mb-6">Categoría: Creaciones funcionales</h1>
      {Object.keys(creacionesItems).map((category) => (
        <Section key={category} category={category} items={creacionesItems[category]} />
      ))}
    </div>
  );
};
